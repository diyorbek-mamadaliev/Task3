...
import static org.epam.testing.google.cloud.Constants.HomePageConstants.EXPLICIT_WAIT;
import static org.epam.testing.google.cloud.Constants.PricingCalculatorPageConstants.*;
...
public class PricingCalculatorPage {
    ...
    @FindBy(xpath = MACHINE_FAMILY_VALUE)
    private WebElement machineFamilyValue;
    ...
    public PricingCalculatorPage chooseMachineFamily(){
        machineFamily.click();
        waitUntilVisibility(machineFamilyValue).click();
        return this;
    }
